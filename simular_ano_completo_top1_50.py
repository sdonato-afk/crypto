...
print("=== INICIANDO SIMULACIÓN DE 365 DÍAS PARA EL BOT DEFINITIVO (TOP 1-50) ===")
...
print(f"Datos descargados para {len(sample_data)} monedas del Top 1-50. Ejecutando motor de 10 slots simultáneos...")
