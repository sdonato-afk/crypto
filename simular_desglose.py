...
print("=== INICIANDO SIMULACIÓN DESGLOSADA TOP 1-50 ===")
...
for i in range(50, min_timeline_len):
    ...
    for symbol, slot in list(active_slots.items()):
        ...
        if high_pnl >= 6.5 and trailing_stage < 2:
...
print(f"Trades Ganadores Totales        : {total_wins}")
print(f"  ↳ Cerrados por TP puro (+9%)  : {wins_tp}")
print(f"  ↳ Cerrados por Lock Trail (+4%): {wins_trail2}")
print(f"  ↳ Cerrados por Breakeven (+0.3%): {wins_trail1}")
print("=========================================================================================")
